...
public class Multi_UnitDataBase : MonoBehaviour
{
    [SerializeField] string[] unitTags;
    public string[] UnitTags => unitTags;
    ...
    public static Dictionary<KeyValuePair<UnitColor, UnitClass>, string> UnitTagDictionary;
    ...
    public void ApplyPassiveData(string _key, Multi_UnitPassive _passive, UnitColor _color)
    {
