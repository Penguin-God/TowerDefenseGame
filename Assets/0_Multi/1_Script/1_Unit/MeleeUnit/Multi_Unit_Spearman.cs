...
public class Multi_Unit_Spearman : Multi_MeleeUnit
{
    ...
    public override void OnAwake()
    {
        ...
        shotSpearData = 
            new ProjectileData(shotSpearData.Original, Multi_Managers.Data.WeaponDataByUnitFlag[UnitFlags].Paths[0], transform, shotSpearData.SpawnTransform);
    }
    ...
    IEnumerator Spearman_SpecialAttack()
    {
        ...
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            Multi_Projectile weapon = ProjectileShotDelegate._ShotProjectile(shotSpearData, transform.forward, OnSkileHit);
