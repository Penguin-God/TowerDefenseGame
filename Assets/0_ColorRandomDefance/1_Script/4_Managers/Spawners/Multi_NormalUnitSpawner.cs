...
public class UnitFiller
{
    ...
    UnitSkillController CreateMageSkillController(Multi_TeamSoldier mage)
    {
        ...
        switch (mage.UnitColor)
        {
            ...
            case UnitColor.Green: return new ShotBounceBall(skillStats[0], skillStats[1], mage);
...
public class Multi_NormalUnitSpawner : MonoBehaviourPun
{
    ...
    [PunRPC]
    public Multi_TeamSoldier RPCSpawn(UnitFlags flag, Vector3 spawnPos, Quaternion rotation, byte id)
    {
