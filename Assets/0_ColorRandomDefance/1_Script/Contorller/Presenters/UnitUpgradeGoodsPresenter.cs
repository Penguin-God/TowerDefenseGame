...
{   
    ...
    public static string BuildAddUpgradeText(UnitUpgradeGoodsData upgradeGoodsData) => $"{new GameCurrencyPresenter().BuildCurrencyText(upgradeGoodsData.Price)} {upgradeGoodsData.UpgradeInfo.DamageRate} 증가";
