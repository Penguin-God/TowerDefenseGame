...
public class ResourcesPathBuilder
{
    ...
    IReadOnlyList<UnitColor> NewMages = new List<UnitColor>() { UnitColor.Yellow, UnitColor.Violet, UnitColor.Orange, UnitColor.Black, UnitColor.Blue, UnitColor.Red, UnitColor.White};
