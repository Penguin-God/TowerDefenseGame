...
public class SuncoldSpeedSystem : SpeedManager
{
    readonly Multi_NormalEnemy _normalMonster;
    readonly int[] _suncoldDamages;
    readonly MultiEffectManager _effect;
    public SuncoldSpeedSystem(float originSpeed, Multi_NormalEnemy normalMonster, int[] damages, MultiEffectManager effect) : base(originSpeed)
    {
